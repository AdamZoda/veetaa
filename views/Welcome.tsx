  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-br from-orange-500 to-red-600 text-white overflow-hidden relative">
      ...
      <div className="relative z-10 text-center space-y-8">
        <div className="w-40 h-40 bg-white rounded-[3rem] flex items-center justify-center shadow-2xl mx-auto rotate-12 mb-8 animate-in zoom-in-50 duration-700">
           <span className="text-orange-600 text-8xl font-black font-brand -rotate-12 select-none">V</span>
        </div>
        <div className="space-y-2 animate-in slide-in-from-bottom-10 duration-1000">
        ...
        <button 
          onClick={onStart}
          className="w-full max-w-xs py-5 px-8 bg-white text-orange-600 rounded-[2rem] font-black text-xl shadow-2xl shadow-orange-900/20 hover:scale-105 active:scale-95 transition-all uppercase tracking-wider animate-in fade-in zoom-in duration-500 delay-500"
        >
          {t('getStarted')}
        </button>
      </div>
